...
if (isset($kode)) {
  $sql_cek = "SELECT * FROM operator WHERE id_operator='" . $kode . "'";
...
<div class="row justify-content-center">
  <div class="col-md-11">
    <div class="card shadow">
      ...
      <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data">
          <input type="hidden" name="id" value="<?= $data_cek['id_operator'] ?>">
          <div class="form-group row">
            <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Manager :</label>
            <div class="col-sm-9">
              <input type="text" name="nama" class="form-control" value="<?= $data_cek['nama_oper'] ?>" id="inputEmail3" placeholder="Nama Barang" required>
            </div>
          </div>
          <div class="form-group row">
    ...
    if (isset($_POST['submit'])) {
      $sql_ubah = "UPDATE operator SET
		nama_oper ='" . $_POST['nama'] . "',
    ...
    kode_jurusan='" . $_POST['jurusan'] . "'				
      ...
      if ($query_ubah) {
        ...
        Swal.fire({title: 'Ubah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
            ...
            if (result.value) {
                window.location = 'index.php?page=data-operator';
            }
        })</script>";
      } else {
        echo "<script>
        Swal.fire({title: 'Ubah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
            ...
            if (result.value) {
                window.location = 'index.php?page=edit-operator';
            }
        })</script>";
      }
    }
