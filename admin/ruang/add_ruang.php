                ...
                <div class="col-md-8">
                  <div class="card shadow mb-4">
                    <div class="card-header">
                      <strong class="card-title">Tambah Data Ruang Inventaris</strong>
                    </div>
                    <div class="card-body">
                      <form action="" method="POST" class="needs-validation" novalidate>
                        <div class="form-row">
                          <div class="col-md-6 mb-3">
                            ...
                            <div class="invalid-feedback"> Nama Ruang Tidak Boleh Kosong ! </div>
                          </div>
                          <div class="col-md-6 mb-3">
                            <label for="validationCustomUsername">Kode Ruang</label>
                        ...
                        <button class="btn btn-primary" name="tambah" type="submit" onclick="return confirm('Ingin Menambahkan Data ?')">Tambah Ruang</button>
...
<?php
		if (isset($_POST['tambah'])){
			...
			$sql_simpan = "INSERT INTO ruang (id_ruang, nama_ruang,kode_ruang, keterangan_ruang) VALUES (
			'".NULL."',
			'".$_POST['nama']."',
			'".$_POST['kondisi']."',
			'".$_POST['keterangan']."');";
		...
		Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
			...
			window.location = 'index.php?page=add-ruang';
			}
		})</script>"
		;
		}}
