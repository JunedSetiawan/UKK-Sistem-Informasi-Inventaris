...
<body>
    ...
    <div style="margin: 0 auto;">
        <center>
            <br />
            <h3> Laporan Perbaikan Operator Jurusan : <?= $data_namajurusan; ?> </h3>
        </center>
        ...
        <table border="1">
            ...
            $aaa = mysqli_fetch_array($ddd);
              ...
              if ($aaa['id_operator'] == 0) {
                $sql = mysqli_query($koneksi,"SELECT perbaikan.*,inventaris.*, admin.nama,ruang.nama_ruang FROM perbaikan
              ...
              <?php
              if ($aaa['id_operator'] !== 0) {
                $sql = mysqli_query($koneksi,"SELECT perbaikan.*,inventaris.*, operator.nama_oper,ruang.nama_ruang FROM perbaikan
